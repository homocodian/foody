...
import { login, signInWithGoogle } from "../utils/firebase/firebaseAuth";
    ...
    <Layout title="Login">
      ...
      <main>
        ...
        <div className="mx-4 my-8 grid place-items-center gap-8">
          ...
          {/* login button */}
          <button
            className="inline-flex justify-center items-center bg-dark-green px-8 py-2 w-[250px] md:w-[300px] text-center text-xs rounded-[3px] hover:bg-green text-white shadow-md -mt-2"
